...
/**
 * Divisors for VE.Direct numeric fields.
 * Keys not present here are passed through as raw strings.
 */
const NUMERIC_DIVISORS = {
	'CE':     1000,
	'V':      1000,
	'V2':     1000,
	'V3':     1000,
...
function convertValue(key, rawValue) {
	if (Object.prototype.hasOwnProperty.call(NUMERIC_DIVISORS, key)) {
		return Math.floor(Number(rawValue)) / NUMERIC_DIVISORS[key];
	}
	return rawValue;
}
