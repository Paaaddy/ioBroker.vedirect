...
describe('convertValue', () => {
    describe('numeric scaling', () => {
        it('converts mV to V (divide by 1000)', () => {
            expect(convertValue('V', '12650')).to.equal(12);   // Math.floor(12650/1000)
        });

        it('converts V2 the same as V', () => {
            expect(convertValue('V2', '12650')).to.equal(12);
        });

        it('converts SOC (divide by 10)', () => {
            expect(convertValue('SOC', '975')).to.equal(97);
        });

        it('converts H17 (divide by 100)', () => {
            expect(convertValue('H17', '1234')).to.equal(12);
        });
